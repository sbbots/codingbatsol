...
public class Warmup1 {
	...
	public boolean nearHundred(int n) {
		...
		if ((diff100 >= -10 && diff100 <= 10)
				|| (diff200 >= -10 && diff200 <= 10)) {
			return true;
		}
		return false;
	}
	...
	public String notString(String str) {
		...
		if (len >= 3 && "not".equals(str.substring(0, 3))) {
			return str;
		} else {
			return "not " + str;
		}
	...
	public String backAround(String str) {
		int len = str.length();
		return str.charAt(len - 1) + str + str.charAt(len - 1);
	}
	...
	public boolean startHi(String str) {
		...
		if (len > 1 && "hi".contentEquals(str.substring(0, 2))) {
			return true;
		}
		return false;
	}
	...
	public boolean loneTeen(int a, int b) {
		return ((isTeen1(a) && !isTeen1(b)) || (!isTeen1(a) && isTeen1(b)));
	}

	public boolean isTeen1(int x) {
		return (x >= 13 && x <= 19);
	}
	...
	public String delDel(String str) {
		...
		if (len >= 4 && "del".contentEquals(str.substring(1, 4))) {
			return str.charAt(0) + str.substring(4, len);
		} else {
			return str;
		}
	}
	...
	public boolean mixStart(String str) {
		...
		return "ix".contentEquals(str.substring(1, 3));
	}
	...
	public String startOz(String str) {
		...
		if (len >= 2) {
			String checkO = str.substring(0, 1);
			String checkX = str.substring(1, 2);

			if (checkO.contentEquals("o")) {
				res = res + checkO;
			}

			if (checkX.contentEquals("z")) {
				res = res + checkX;
			}
		}
		return res;
	...
	public int close10(int a, int b) {
		...
		boolean isEqual = Math.abs(10 - a) == Math.abs(10 - b);

		return isEqual ? 0 : (Math.abs(10 - a) < Math.abs(10 - b) ? a : b);
	}
	...
	public int max1020(int a, int b) {
		...
		if (inRange(a) && inRange(b)) {return (a > b ? a : b);}
	...
	public boolean stringE(String str) {
		...
		while (len >= 0) {
			if (String.valueOf(str.charAt(len)).equals("e")) {
				x++;
			}
			len--;
		}
